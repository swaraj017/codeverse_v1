...
const RoomIdCard = ({ roomId, copyRoomId }) => (
  <div className="bg-slate-800/60 backdrop-blur-sm px-9 py-4 rounded-xl border border-slate-700/50 flex items-center gap-3 h-[70px] w-80 hover:bg-slate-800/80 transition-all duration-300 shadow-lg">
